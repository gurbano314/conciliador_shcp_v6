% ============================================================
%  MANUAL DE USUARIO — Conciliador de Cotizaciones v6.5
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\color{vino}\small\textbf{Conciliador de Cotizaciones v6.5}}
...
\usepackage[
  ...
  urlcolor=SteelBlue,
  citecolor=vino,
  pdftitle={Manual de Usuario – Conciliador de Cotizaciones v6.5},
  pdfauthor={SHCP - UPIT},
...
\title{%
  ...
  {\Large\color{vino!70!black}Manual de Usuario — v6.5}\\[10pt]
...
El \textbf{Conciliador de Cotizaciones v6.5} es una aplicación de escritorio para
...
\begin{table}[H]
  ...
  \begin{tabularx}{\linewidth}{lX}
    ...
    \midrule
    \btn{☰} (Hamburguesa) & Muestra u oculta el panel lateral de configuración.
                             Útil para ganar espacio en pantallas pequeñas. \\
    \btn{💾 Guardar}      & Guarda el proyecto actual en el archivo \texttt{.cshcp}
...
v6.5 para abrirlo y continuar exactamente donde lo dejaste.
\end{notabox}
...
\begin{itemize}
  \item Este comportamiento está \textbf{corregido en v6.5}. Todos los
  ...
  \item Si usas una versión anterior, actualiza a v6.5.
\end{itemize}
...
tabla y token) en un archivo \texttt{.cshcp} con el botón \btn{💾 Guardar}
...
\begin{center}
  ...
  {\color{vino}\large Conciliador de Cotizaciones v6.5}\\[6pt]
