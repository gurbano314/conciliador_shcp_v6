% ============================================================
%  MANUAL DE USUARIO — Conciliador de Cotizaciones v6.0
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\color{vino}\small\textbf{Conciliador de Cotizaciones v6.0}}
...
\usepackage[
  ...
  urlcolor=SteelBlue,
  citecolor=vino,
  pdftitle={Manual de Usuario – Conciliador de Cotizaciones v6.0},
  pdfauthor={SHCP - UPIT},
...
\title{%
  ...
  {\Large\color{vino!70!black}Manual de Usuario — v6.0}\\[10pt]
...
\begin{titlepage}
  ...
  {\color{vinoLite}\large Versión 6.0}\\[40pt]
  {\color{vino!70!black}\normalsize
...
El \textbf{Conciliador de Cotizaciones v6.0} es una aplicación de escritorio para
...
analizar. Puedes agregar hasta 50 secciones.
...
\begin{enumerate}
  ...
  \item Inicia sesión con tu cuenta del Banco de México.
...
\begin{notabox}
La columna \campo{Diferencia final} es de solo lectura — se calcula como
...
\vspace*{\fill}
\begin{center}
  {\color{vinoLite}\rule{0.6\linewidth}{1pt}}\\[12pt]
  {\color{textMuted}\large Conciliador de Cotizaciones v6.0}\\[6pt]
  {\color{textMuted}\small Manual de Usuario}\\[6pt]
  {\color{textMuted}\small SHCP - UPIT · \today}\\[12pt]
  {\color{vinoLite}\rule{0.6\linewidth}{1pt}}
\end{center}
\vspace*{\fill}
